...
// POST /api/upload/artwork-images
router.post('/artwork-images', adminAuth, uploadArtworkImages, (req, res) => {
  res.json({
...
// POST /api/upload/reference-images
router.post('/reference-images', uploadReferenceImages, (req, res) => {
  res.json({
...
module.exports.uploadReferenceImages = uploadReferenceImages;
module.exports.uploadArtworkImages = uploadArtworkImages;
